...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t2 = claim_text(strong_nodes, /*average*/ ctx[2]);
    		...
    		h: function hydrate() {
    			...
    			attr_dev(path0, "d", path0_d_value = d(/*highlightPercent*/ ctx[6]));
    			toggle_class(path0, "visible", /*average*/ ctx[2] && /*value*/ ctx[1]);
    			add_location(path0, file$9, 137, 2, 3281);
    			attr_dev(path1, "class", "cover svelte-107f1uw");
    			attr_dev(path1, "d", path1_d_value = d(/*coverPercent*/ ctx[5]));
    			toggle_class(path1, "visible", /*average*/ ctx[2]);
    			add_location(path1, file$9, 138, 2, 3367);
    			...
    			add_location(svg, file$9, 132, 1, 3099);
    			...
    			add_location(div, file$9, 129, 0, 3000);
    			attr_dev(strong, "class", "svelte-107f1uw");
    			add_location(strong, file$9, 142, 25, 3560);
    			attr_dev(p, "id", p_id_value = "" + (/*uniqueSlug*/ ctx[0] + "-outer-label"));
    			attr_dev(p, "class", "label svelte-107f1uw");
    			toggle_class(p, "visible", /*start*/ ctx[4] && /*end*/ ctx[3] && /*value*/ ctx[1]);
    			add_location(p, file$9, 141, 0, 3449);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*highlightPercent*/ 64 && path0_d_value !== (path0_d_value = d(/*highlightPercent*/ ctx[6]))) {
    				attr_dev(path0, "d", path0_d_value);
    			}

    			if (dirty & /*average, value*/ 6) {
    				toggle_class(path0, "visible", /*average*/ ctx[2] && /*value*/ ctx[1]);
    			}

    			if (dirty & /*coverPercent*/ 32 && path1_d_value !== (path1_d_value = d(/*coverPercent*/ ctx[5]))) {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	let { average } = $$props;
    	const writable_props = ['uniqueSlug', 'min', 'max', 'value', 'average'];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('average' in $$props) $$invalidate(2, average = $$props.average);
    		if ('startValue' in $$props) $$invalidate(9, startValue = $$props.startValue);
    		if ('coverPercent' in $$props) $$invalidate(5, coverPercent = $$props.coverPercent);
    		if ('endValue' in $$props) $$invalidate(10, endValue = $$props.endValue);
    		if ('highlightPercent' in $$props) $$invalidate(6, highlightPercent = $$props.highlightPercent);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*average*/ 4) {
    			// Let's take a little below and a little above
    			// It's a little imprecise, yes, but we need
    			// some pixels to display
    			$$invalidate(4, start = parseInt(average) - 0.5);
    		}

    		if ($$self.$$.dirty & /*average*/ 4) {
    			$$invalidate(3, end = parseInt(average) + 0.5);
    		}

    		if ($$self.$$.dirty & /*start, min*/ 144) {
    			// Make sure our numbers are not outside the range
    			$$invalidate(9, startValue = start < min ? min : start);
    		}

    		if ($$self.$$.dirty & /*end, max*/ 264) {
    			$$invalidate(10, endValue = end > max ? max : end);
    		}

    		if ($$self.$$.dirty & /*endValue, min*/ 1152) {
    			...
    			$$invalidate(6, highlightPercent = (endValue - min) / range / 2);
    		}

    		if ($$self.$$.dirty & /*startValue, min*/ 640) {
    			$$invalidate(5, coverPercent = (startValue - min) / range / 2);
    		}
    	};
    ...
    class DialOuter extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*min*/ ctx[7] === undefined && !('min' in props)) {
    			console_1$2.warn("<DialOuter> was created without expected prop 'min'");
    		}

    		if (/*max*/ ctx[8] === undefined && !('max' in props)) {
    			console_1$2.warn("<DialOuter> was created without expected prop 'max'");
    		}

    		if (/*value*/ ctx[1] === undefined && !('value' in props)) {
    			console_1$2.warn("<DialOuter> was created without expected prop 'value'");
    		}
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(title_1, file$8, 28, 12, 505);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(path0, "class", "needle-1 svelte-v1o021");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*value*/ 32) dialouter_changes.value = /*value*/ ctx[5];
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t1 = claim_text(time_1_nodes, /*timeFormatted*/ ctx[3]);
    			time_1_nodes.forEach(detach_dev);
    			span_nodes.forEach(detach_dev);
    			this.h();
    		},
    		h: function hydrate() {
    			add_location(br, file$6, 63, 18, 1186);
    			attr_dev(time_1, "datetime", time_1_datetime_value = /*time*/ ctx[2].getTime());
    			add_location(time_1, file$6, 63, 24, 1192);
    			attr_dev(span, "class", "timestamp svelte-6mzy8v");
    			attr_dev(span, "aria-hidden", span_aria_hidden_value = !/*updated*/ ctx[0]);
    			toggle_class(span, "visible", /*updated*/ ctx[0] && /*value*/ ctx[1]);
    			add_location(span, file$6, 62, 0, 1087);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*timeFormatted*/ 8) set_data_dev(t1, /*timeFormatted*/ ctx[3]);

    			if (dirty & /*time*/ 4 && time_1_datetime_value !== (time_1_datetime_value = /*time*/ ctx[2].getTime())) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['updated', 'value'];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('timeFormatted' in $$props) $$invalidate(3, timeFormatted = $$props.timeFormatted);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*updated*/ 1) {
    			$$invalidate(2, time = new Date(updated) || "");
    		}

    		if ($$self.$$.dirty & /*time*/ 4) {
    			$$invalidate(3, timeFormatted = formatTime(time));
    		}
    	};

    	return [updated, value, time, timeFormatted];
    }

    class Timestamp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { updated: 0, value: 1 });
    ...
    // (141:2) {#each stops as [label, position]}
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(li, "class", "stop svelte-xrmqk5");
    			set_style(li, "left", /*position*/ ctx[17] + "%");
    			add_location(li, file$4, 141, 3, 2635);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, li, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(141:2) {#each stops as [label, position]}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(span, "class", "tick tick--average svelte-xrmqk5");
    			add_location(span, file$4, 148, 3, 2772);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, span, anchor);
    		},
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(span, "class", "tick tick--high svelte-xrmqk5");
    			add_location(span, file$4, 151, 3, 2868);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, span, anchor);
    		},
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(span, "class", "tick tick--low svelte-xrmqk5");
    			add_location(span, file$4, 154, 3, 2960);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, span, anchor);
    		},
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(span, "class", "tick tick--value svelte-xrmqk5");
    			add_location(span, file$4, 157, 3, 3043);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, span, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	let span1;
    	let t6;
    	let t7_value = getLabel(/*average*/ ctx[2], /*value*/ ctx[1]) + "";
    	let t7;
    	let t8;
    	let li1;
    	let span2;
    	...
    	let span3;
    	let t10;
    	let t11_value = getLabel(/*high*/ ctx[3], /*value*/ ctx[1]) + "";
    	let t11;
    	let t12;
    	let li2;
    	let span4;
    	...
    	let span5;
    	let t14;
    	let t15_value = getLabel(/*low*/ ctx[4], /*value*/ ctx[1]) + "";
    	let t15;
    	let t16;
    	let li3;
    	let span6;
    	...
    	let span7;
    	let t18;
    	let t19_value = getLabel(/*value*/ ctx[1], /*value*/ ctx[1]) + "";
    	let t19;
    	let div1_id_value;
    	...
    	let if_block0 = /*value*/ ctx[1] && /*average*/ ctx[2] && create_if_block_3(ctx);
    	let if_block1 = /*value*/ ctx[1] && /*high*/ ctx[3] && create_if_block_2$1(ctx);
    	let if_block2 = /*value*/ ctx[1] && /*low*/ ctx[4] && create_if_block_1$1(ctx);
    	let if_block3 = /*value*/ ctx[1] && create_if_block$4(ctx);
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t6 = claim_text(span1_nodes, "Average: ");
    			...
    			t10 = claim_text(span3_nodes, "High: ");
    			...
    			t13 = claim_space(li2_nodes);
    			span5 = claim_element(li2_nodes, "SPAN", { class: true });
    			var span5_nodes = children(span5);
    			t14 = claim_text(span5_nodes, "Low: ");
    			...
    			t17 = claim_space(li3_nodes);
    			span7 = claim_element(li3_nodes, "SPAN", { class: true });
    			var span7_nodes = children(span7);
    			t18 = claim_text(span7_nodes, "Latest: ");
    			t19 = claim_text(span7_nodes, t19_value);
    		...
    		h: function hydrate() {
    			attr_dev(ul0, "class", "stops svelte-xrmqk5");
    			add_location(ul0, file$4, 139, 1, 2576);
    			attr_dev(div0, "class", "gauge__chart svelte-xrmqk5");
    			add_location(div0, file$4, 146, 1, 2717);
    			attr_dev(span0, "class", "tick tick--average svelte-xrmqk5");
    			add_location(span0, file$4, 162, 3, 3173);
    			attr_dev(span1, "class", "legend__text svelte-xrmqk5");
    			add_location(span1, file$4, 163, 3, 3212);
    			attr_dev(li0, "class", "legend__item svelte-xrmqk5");
    			add_location(li0, file$4, 161, 2, 3144);
    			attr_dev(span2, "class", "tick tick--high svelte-xrmqk5");
    			add_location(span2, file$4, 166, 3, 3300);
    			attr_dev(span3, "class", "legend__text svelte-xrmqk5");
    			add_location(span3, file$4, 167, 3, 3336);
    			attr_dev(li1, "class", "svelte-xrmqk5");
    			add_location(li1, file$4, 165, 2, 3292);
    			attr_dev(span4, "class", "tick tick--low svelte-xrmqk5");
    			add_location(span4, file$4, 170, 3, 3418);
    			attr_dev(span5, "class", "legend__text svelte-xrmqk5");
    			add_location(span5, file$4, 171, 3, 3453);
    			attr_dev(li2, "class", "svelte-xrmqk5");
    			add_location(li2, file$4, 169, 2, 3410);
    			attr_dev(span6, "class", "tick tick--value svelte-xrmqk5");
    			add_location(span6, file$4, 174, 3, 3533);
    			attr_dev(span7, "class", "legend__text svelte-xrmqk5");
    			add_location(span7, file$4, 175, 3, 3570);
    			attr_dev(li3, "class", "svelte-xrmqk5");
    			add_location(li3, file$4, 173, 2, 3525);
    			attr_dev(ul1, "class", "legend svelte-xrmqk5");
    			add_location(ul1, file$4, 160, 1, 3122);
    			attr_dev(div1, "id", div1_id_value = "" + (/*uniqueSlug*/ ctx[0] + "-gauge"));
    			attr_dev(div1, "class", "gauge svelte-xrmqk5");
    			add_location(div1, file$4, 138, 0, 2531);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_hydration_dev(li2, span5);
    			append_hydration_dev(span5, t14);
    			append_hydration_dev(span5, t15);
    			append_hydration_dev(ul1, t16);
    			append_hydration_dev(ul1, li3);
    			append_hydration_dev(li3, span6);
    			append_hydration_dev(li3, t17);
    			append_hydration_dev(li3, span7);
    			append_hydration_dev(span7, t18);
    			append_hydration_dev(span7, t19);
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*stops*/ 512) {
    			...
    			if (dirty & /*average, value*/ 6 && t7_value !== (t7_value = getLabel(/*average*/ ctx[2], /*value*/ ctx[1]) + "")) set_data_dev(t7, t7_value);
    			if (dirty & /*high, value*/ 10 && t11_value !== (t11_value = getLabel(/*high*/ ctx[3], /*value*/ ctx[1]) + "")) set_data_dev(t11, t11_value);
    			if (dirty & /*low, value*/ 18 && t15_value !== (t15_value = getLabel(/*low*/ ctx[4], /*value*/ ctx[1]) + "")) set_data_dev(t15, t15_value);
    			if (dirty & /*value*/ 2 && t19_value !== (t19_value = getLabel(/*value*/ ctx[1], /*value*/ ctx[1]) + "")) set_data_dev(t19, t19_value);
    ...
    // (148:1) {#if $fetchingData}
    function create_if_block$2(ctx) {
    	let loadinganimation;
    	let current;

    	loadinganimation = new LoadingAnimation({
    			props: { text: "Refreshing data" },
    			$$inline: true
    		});
    ...
    function create_fragment$2(ctx) {
    	...
    	let if_block = /*$fetchingData*/ ctx[16] && create_if_block$2(ctx);
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t0 = claim_text(h2_nodes, /*name*/ ctx[1]);
    			...
    			var span1_nodes = children(span1);
    			t8 = claim_text(span1_nodes, /*value*/ ctx[9]);
    		...
    		h: function hydrate() {
    			...
    			add_location(h2, file$2, 139, 1, 3000);
    			attr_dev(p, "class", "description svelte-12cf46x");
    			add_location(p, file$2, 140, 1, 3030);
    			attr_dev(span0, "aria-hidden", span0_aria_hidden_value = !/*value*/ ctx[9]);
    			attr_dev(span0, "class", "label svelte-12cf46x");
    			toggle_class(span0, "visible", /*value*/ ctx[9]);
    			add_location(span0, file$2, 143, 1, 3178);
    			attr_dev(span1, "aria-hidden", span1_aria_hidden_value = !/*value*/ ctx[9]);
    			attr_dev(span1, "class", "value svelte-12cf46x");
    			toggle_class(span1, "visible", /*value*/ ctx[9]);
    			add_location(span1, file$2, 144, 1, 3257);
    			attr_dev(div, "id", /*uniqueSlug*/ ctx[14]);
    			attr_dev(div, "class", div_class_value = "dial dial--" + /*caution*/ ctx[7] + " svelte-12cf46x");
    			attr_dev(div, "aria-hidden", div_aria_hidden_value = !/*visible*/ ctx[0]);
    			toggle_class(div, "visible", /*visible*/ ctx[0]);
    			add_location(div, file$2, 138, 0, 2911);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*average*/ 1024) charts_changes.average = /*average*/ ctx[10];
    			if (dirty & /*min*/ 8) charts_changes.min = /*min*/ ctx[3];
    			if (dirty & /*max*/ 16) charts_changes.max = /*max*/ ctx[4];
    			if (dirty & /*value*/ 512) charts_changes.value = /*value*/ ctx[9];
    			...
    			if (dirty & /*value*/ 512) timestamp_changes.value = /*value*/ ctx[9];
    			...
    			if (!current || dirty & /*value*/ 512 && span0_aria_hidden_value !== (span0_aria_hidden_value = !/*value*/ ctx[9])) {
    			...
    			if (!current || dirty & /*value*/ 512) set_data_dev(t8, /*value*/ ctx[9]);

    			if (!current || dirty & /*value*/ 512 && span1_aria_hidden_value !== (span1_aria_hidden_value = !/*value*/ ctx[9])) {
    			...
    			const cso_1_changes = {};
    			if (dirty & /*cso*/ 256) cso_1_changes.cso = /*cso*/ ctx[8];
    			cso_1.$set(cso_1_changes);
    			const gauge_changes = {};
    			if (dirty & /*uniqueSlug*/ 16384) gauge_changes.uniqueSlug = /*uniqueSlug*/ ctx[14];
    			if (dirty & /*average*/ 1024) gauge_changes.average = /*average*/ ctx[10];
    			...
    			if (!current || dirty & /*caution*/ 128 && div_class_value !== (div_class_value = "dial dial--" + /*caution*/ ctx[7] + " svelte-12cf46x")) {
    				attr_dev(div, "class", div_class_value);
    			}

    			if (!current || dirty & /*visible*/ 1 && div_aria_hidden_value !== (div_aria_hidden_value = !/*visible*/ ctx[0])) {
    				attr_dev(div, "aria-hidden", div_aria_hidden_value);
    			}

    			if (dirty & /*caution, visible*/ 129) {
    				toggle_class(div, "visible", /*visible*/ ctx[0]);
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('caution' in $$props) $$invalidate(7, caution = $$props.caution);
    		if ('labels' in $$props) $$invalidate(18, labels = $$props.labels);
    		if ('cso' in $$props) $$invalidate(8, cso = $$props.cso);
    		if ('value' in $$props) $$invalidate(9, value = $$props.value);
    		if ('average' in $$props) $$invalidate(10, average = $$props.average);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*labels, caution*/ 262272) {
    ...
    class Dial extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*caution*/ ctx[7] === undefined && !('caution' in props)) {
    		...
    		if (/*average*/ ctx[10] === undefined && !('average' in props)) {
    ...
    function create_if_block(ctx) {
    	...
    	inputselect.$on("input", /*input_handler*/ ctx[11]);
    ...
    // (318:2) {#each Object.entries(dials) as [id, dial]}
    function create_each_block(ctx) {
    	...
    	const dial_spread_levels = [
    		{
    			visible: /*id*/ ctx[13] === /*visibleBranch*/ ctx[1] || !/*$isMobile*/ ctx[4]
    		},
    		/*dial*/ ctx[14],
    		/*$gaugeData*/ ctx[3][/*id*/ ctx[13]],
    		{ labels: /*labels*/ ctx[9] },
    		{
    			cso: /*csoEvents*/ ctx[2][/*id*/ ctx[13]]
    		}
    	];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(dial_spread_levels, [
    					...
    					dirty & /*Object, dials*/ 1 && get_spread_object(/*dial*/ ctx[14]),
    					dirty & /*$gaugeData, Object, dials*/ 9 && get_spread_object(/*$gaugeData*/ ctx[3][/*id*/ ctx[13]]),
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(318:2) {#each Object.entries(dials) as [id, dial]}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "dials svelte-1d4pe7o");
    			toggle_class(div0, "dials--grid", !/*$isMobile*/ ctx[4]);
    			add_location(div0, file, 316, 1, 8172);
    			attr_dev(div1, "class", "water-quality svelte-1d4pe7o");
    			add_location(div1, file, 305, 0, 7916);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
    ...
    const MAIN_STEM = "https://dvlzjowx88.execute-api.us-west-2.amazonaws.com/h2now/tryptophan/main-stem/latest";
    const NORTH_AND_SOUTH = "https://dvlzjowx88.execute-api.us-west-2.amazonaws.com/h2now/tryptophan/north-south/latest";
    const CSO = "https://dvlzjowx88.execute-api.us-west-2.amazonaws.com/h2now/all-branches/cso-event/latest";
    ...
    function getCaution(branch, value, csoEvents) {
    	...
    	let breaks = {
    		main: [["good", 3], ["low", 6]],
    		south: [["good", 24], ["low", 37]],
    		north: [["good", 33], ["low", 52]]
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_store(fetchingData, 'fetchingData');
    	component_subscribe($$self, fetchingData, value => $$invalidate(12, $fetchingData = value));
    	...
    	onMount(async () => {
    					...
    					(acc, cur) => {
    						...
    						if (title.toLowerCase().includes("downstream")) {
    							try {
    								...
    								acc.south = (today - csoDate) / 1000 / 60 / 60 > CSO_DURATION
    								? ""
    								: new Date(valueDate);
    							} catch(e) {
    							...
    							try {
    								...
    								acc.north = (today - csoDate) / 1000 / 60 / 60 > CSO_DURATION
    								? ""
    								: new Date(valueDate);
    							} catch(e) {
    								// This is not a valid date. Ignore it.
    							...
    							try {
    								...
    								// If the time of the last CSO was less than 72 hours ago, store the date
    								acc.main = (today - csoDate) / 1000 / 60 / 60 > CSO_DURATION
    								? ""
    								: new Date(valueDate);
    							} catch(e) {
    								// This is not a valid date. Ignore it.
    		...
    		const main = fetch(MAIN_STEM).then(r => r.json()).then(data => {
    			...
    			if (data.timestamp) {
    				set_store_value(gaugeData, $gaugeData.main.updated = data.timestamp, $gaugeData);
    			}
    		}).catch(console.error);

    		// Also do the NORTH/SOUTH
    		const branches = fetch(NORTH_AND_SOUTH).then(r => r.json()).then(data => {
    					...
    					switch (title) {
    						case "NB Last Hour Average":
    							if (value) {
    								...
    								set_store_value(gaugeData, $gaugeData.north.updated = dateRange.to, $gaugeData);
    							}
    							break;
    						...
    						case "SB Last Hour Average":
    							if (value) {
    								...
    								set_store_value(gaugeData, $gaugeData.south.updated = dateRange.to, $gaugeData);
    							}
    							break;
    			...
    			if (data.timestamp) {
    				set_store_value(gaugeData, $gaugeData.north.updated = data.timestamp, $gaugeData);
    				set_store_value(gaugeData, $gaugeData.south.updated = data.timestamp, $gaugeData);
    			}
    		}).catch(console.error);
