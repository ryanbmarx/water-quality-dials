...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*average_low*/ ctx[3] && /*average_high*/ ctx[2]) return create_if_block;
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*valueLabel*/ 8192) set_data_dev(t6, /*valueLabel*/ ctx[13]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*value*/ 1) {
    			$$invalidate(13, valueLabel = getValueLabel(value));
    		}
    	};
    ...
    // (75:2) {#each dials as dial}
    function create_each_block(ctx) {
    	let dial;
    	let current;
    	const dial_spread_levels = [/*dial*/ ctx[1]];
    	let dial_props = {};
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const dial_changes = (dirty & /*dials*/ 1)
    			? get_spread_update(dial_spread_levels, [get_spread_object(/*dial*/ ctx[1])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(75:2) {#each dials as dial}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "dials svelte-1werihe");
    			add_location(div0, file, 73, 1, 1519);
    			attr_dev(div1, "class", "water-quality");
    			add_location(div1, file, 72, 0, 1490);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
    			append_hydration_dev(div1, div0);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { dials = [] } = $$props;
    	setContext(contextKey, { isMobile: writable(false) });
