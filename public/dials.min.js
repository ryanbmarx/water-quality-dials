...
var app = (function () {
    ...
    // (305:2) {#each Object.entries(dials) as [id, dial]}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(305:2) {#each Object.entries(dials) as [id, dial]}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file, 303, 1, 7843);
    			attr_dev(div1, "class", "water-quality svelte-1d4pe7o");
    			add_location(div1, file, 292, 0, 7587);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
