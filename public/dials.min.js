...
var app = (function () {
    ...
    // (306:2) {#each Object.entries(dials) as [id, dial]}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(306:2) {#each Object.entries(dials) as [id, dial]}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "dials svelte-792de6");
    			toggle_class(div0, "dials--grid", !/*$isMobile*/ ctx[4]);
    			add_location(div0, file, 304, 1, 7679);
    			attr_dev(div1, "class", "water-quality svelte-792de6");
    			add_location(div1, file, 293, 0, 7423);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
