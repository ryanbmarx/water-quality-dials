...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path0, file$9, 138, 2, 3262);
    			...
    			add_location(path1, file$9, 139, 2, 3339);
    			...
    			add_location(svg, file$9, 133, 1, 3080);
    			...
    			add_location(div, file$9, 130, 0, 2981);
    			attr_dev(strong, "class", "svelte-107f1uw");
    			add_location(strong, file$9, 143, 25, 3523);
    			...
    			add_location(p, file$9, 142, 0, 3421);
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*average*/ 2) {
    			...
    			$$invalidate(3, start = average - 0.5);
    		}

    		if ($$self.$$.dirty & /*average*/ 2) {
    			$$invalidate(2, end = average + 0.5);
    		}
    ...
    class CSO extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h2, "class", "stem svelte-1uxbk63");
    			add_location(h2, file$2, 140, 1, 3019);
    			attr_dev(p, "class", "description svelte-1uxbk63");
    			add_location(p, file$2, 141, 1, 3049);
    			attr_dev(span0, "aria-hidden", span0_aria_hidden_value = !/*value*/ ctx[10]);
    			attr_dev(span0, "class", "label svelte-1uxbk63");
    			toggle_class(span0, "visible", /*value*/ ctx[10]);
    			add_location(span0, file$2, 144, 1, 3189);
    			attr_dev(span1, "aria-hidden", span1_aria_hidden_value = !/*value*/ ctx[10]);
    			attr_dev(span1, "class", "value svelte-1uxbk63");
    			toggle_class(span1, "visible", /*value*/ ctx[10]);
    			add_location(span1, file$2, 145, 1, 3268);
    			attr_dev(div, "id", /*uniqueSlug*/ ctx[14]);
    			attr_dev(div, "class", div_class_value = "dial dial--" + /*caution*/ ctx[8] + " svelte-1uxbk63");
    			attr_dev(div, "aria-hidden", div_aria_hidden_value = !/*visible*/ ctx[1]);
    			toggle_class(div, "visible", /*visible*/ ctx[1]);
    			add_location(div, file$2, 139, 0, 2930);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*caution*/ 256 && div_class_value !== (div_class_value = "dial dial--" + /*caution*/ ctx[8] + " svelte-1uxbk63")) {
    ...
    function create_if_block(ctx) {
    	...
    	function inputselect_value_binding(value) {
    		/*inputselect_value_binding*/ ctx[9](value);
    	}
    ...
    // (135:2) {#each Object.entries(dials) as [id, dial]}
    function create_each_block(ctx) {
    	...
    	const dial_spread_levels = [
    		{
    			visible: /*id*/ ctx[11] === /*visibleBranch*/ ctx[1] || !/*$isMobile*/ ctx[3]
    		},
    		/*dial*/ ctx[12],
    		/*$data*/ ctx[2][/*id*/ ctx[11]],
    		{ labels: /*labels*/ ctx[7] }
    	];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const dial_changes = (dirty & /*Object, dials, visibleBranch, $isMobile, $data, labels*/ 143)
    			? get_spread_update(dial_spread_levels, [
    					dirty & /*Object, dials, visibleBranch, $isMobile*/ 11 && {
    						visible: /*id*/ ctx[11] === /*visibleBranch*/ ctx[1] || !/*$isMobile*/ ctx[3]
    					},
    					dirty & /*Object, dials*/ 1 && get_spread_object(/*dial*/ ctx[12]),
    					dirty & /*$data, Object, dials*/ 5 && get_spread_object(/*$data*/ ctx[2][/*id*/ ctx[11]]),
    					dirty & /*labels*/ 128 && { labels: /*labels*/ ctx[7] }
    				])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(135:2) {#each Object.entries(dials) as [id, dial]}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file, 133, 1, 3050);
    			attr_dev(div1, "class", "water-quality");
    			add_location(div1, file, 125, 0, 2890);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*Object, dials, visibleBranch, $isMobile, $data, labels*/ 143) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { dials = [] } = $$props;
    	let { data_url = "http://localhost:5000/temp2.json" } = $$props;
    	let data = writable({});
    	...
    	onMount(async () => {
    		try {
    			...
    			set_store_value(data, $data = await fetch(data_url).then(response => response.json()), $data);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('data_url' in $$props) $$invalidate(8, data_url = $$props.data_url);
    	};
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { dials: 0, data_url: 8 });
