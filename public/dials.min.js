...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(time_1, file$5, 62, 19, 1147);
    ...
    function create_fragment$2(ctx) {
    	...
    	charts = new Charts({
    			props: {
    				uniqueSlug: /*uniqueSlug*/ ctx[13],
    				average_low: /*average_low*/ ctx[9],
    				average_high: /*average_high*/ ctx[10],
    				min: /*min*/ ctx[4],
    				max: /*max*/ ctx[5],
    				value: /*value*/ ctx[8],
    	...
    	let if_block = !/*value*/ ctx[8] && create_if_block$2(ctx);
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			var span1_nodes = children(span1);
    			t8 = claim_text(span1_nodes, /*value*/ ctx[8]);
    		...
    		h: function hydrate() {
    			...
    			add_location(h2, file$2, 124, 1, 2532);
    			attr_dev(p, "class", "description svelte-oe5d5y");
    			add_location(p, file$2, 125, 1, 2562);
    			attr_dev(span0, "aria-hidden", span0_aria_hidden_value = !/*value*/ ctx[8]);
    			attr_dev(span0, "class", "label svelte-oe5d5y");
    			toggle_class(span0, "visible", /*value*/ ctx[8]);
    			add_location(span0, file$2, 135, 1, 2735);
    			attr_dev(span1, "aria-hidden", span1_aria_hidden_value = !/*value*/ ctx[8]);
    			attr_dev(span1, "class", "value svelte-oe5d5y");
    			toggle_class(span1, "visible", /*value*/ ctx[8]);
    			add_location(span1, file$2, 136, 1, 2819);
    			attr_dev(div, "id", /*uniqueSlug*/ ctx[13]);
    			...
    			add_location(div, file$2, 123, 0, 2459);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*uniqueSlug*/ 8192) charts_changes.uniqueSlug = /*uniqueSlug*/ ctx[13];
    			if (dirty & /*average_low*/ 512) charts_changes.average_low = /*average_low*/ ctx[9];
    			if (dirty & /*average_high*/ 1024) charts_changes.average_high = /*average_high*/ ctx[10];
    			if (dirty & /*min*/ 16) charts_changes.min = /*min*/ ctx[4];
    			if (dirty & /*max*/ 32) charts_changes.max = /*max*/ ctx[5];
    			if (dirty & /*value*/ 256) charts_changes.value = /*value*/ ctx[8];
    			...
    			if (!current || dirty & /*value*/ 256 && span0_aria_hidden_value !== (span0_aria_hidden_value = !/*value*/ ctx[8])) {
    			...
    			if (!current || dirty & /*value*/ 256) set_data_dev(t8, /*value*/ ctx[8]);

    			if (!current || dirty & /*value*/ 256 && span1_aria_hidden_value !== (span1_aria_hidden_value = !/*value*/ ctx[8])) {
    			...
    			const gauge_changes = {};
    			if (dirty & /*uniqueSlug*/ 8192) gauge_changes.uniqueSlug = /*uniqueSlug*/ ctx[13];
    			if (dirty & /*average_low*/ 512) gauge_changes.average_low = /*average_low*/ ctx[9];
    			if (dirty & /*average_high*/ 1024) gauge_changes.average_high = /*average_high*/ ctx[10];
    			if (dirty & /*high*/ 2048) gauge_changes.high = /*high*/ ctx[11];
    			if (dirty & /*low*/ 4096) gauge_changes.low = /*low*/ ctx[12];
    			if (dirty & /*min*/ 16) gauge_changes.min = /*min*/ ctx[4];
    			if (dirty & /*max*/ 32) gauge_changes.max = /*max*/ ctx[5];
    			if (dirty & /*value*/ 256) gauge_changes.value = /*value*/ ctx[8];
    			...
    			if (!current || dirty & /*uniqueSlug*/ 8192) {
    				attr_dev(div, "id", /*uniqueSlug*/ ctx[13]);
    			}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('average_low' in $$props) $$invalidate(9, average_low = $$props.average_low);
    		if ('average_high' in $$props) $$invalidate(10, average_high = $$props.average_high);
    		if ('high' in $$props) $$invalidate(11, high = $$props.high);
    		if ('low' in $$props) $$invalidate(12, low = $$props.low);
    		if ('updated' in $$props) $$invalidate(0, updated = $$props.updated);
    		if ('labels' in $$props) $$invalidate(17, labels = $$props.labels);
    		if ('uniqueSlug' in $$props) $$invalidate(13, uniqueSlug = $$props.uniqueSlug);
    	};
    ...
    class Dial extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*average_low*/ ctx[9] === undefined && !('average_low' in props)) {
    			console.warn("<Dial> was created without expected prop 'average_low'");
    		}

    		if (/*average_high*/ ctx[10] === undefined && !('average_high' in props)) {
    			console.warn("<Dial> was created without expected prop 'average_high'");
    		}

    		if (/*high*/ ctx[11] === undefined && !('high' in props)) {
    			console.warn("<Dial> was created without expected prop 'high'");
    		}

    		if (/*low*/ ctx[12] === undefined && !('low' in props)) {
    ...
    function create_if_block(ctx) {
    	...
    	if (/*visibleBranch*/ ctx[2] !== void 0) {
    		inputselect_props.value = /*visibleBranch*/ ctx[2];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*visibleBranch*/ 4) {
    				updating_value = true;
    				inputselect_changes.value = /*visibleBranch*/ ctx[2];
    ...
    // (126:2) {#each Object.entries(dials) as [id, dial]}
    function create_each_block(ctx) {
    	...
    	const dial_spread_levels = [
    		{
    			visible: /*id*/ ctx[9] === /*visibleBranch*/ ctx[2] || !/*$isMobile*/ ctx[3]
    		},
    		/*dial*/ ctx[10],
    		/*data*/ ctx[1][/*id*/ ctx[9]]
    	];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const dial_changes = (dirty & /*Object, dials, visibleBranch, $isMobile, data*/ 15)
    			? get_spread_update(dial_spread_levels, [
    					dirty & /*Object, dials, visibleBranch, $isMobile*/ 13 && {
    						visible: /*id*/ ctx[9] === /*visibleBranch*/ ctx[2] || !/*$isMobile*/ ctx[3]
    					},
    					dirty & /*Object, dials*/ 1 && get_spread_object(/*dial*/ ctx[10]),
    					dirty & /*data, Object, dials*/ 3 && get_spread_object(/*data*/ ctx[1][/*id*/ ctx[9]])
    				])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(126:2) {#each Object.entries(dials) as [id, dial]}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let div0;
    	let current;
    	let if_block = /*$isMobile*/ ctx[3] && create_if_block(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			toggle_class(div0, "dials--grid", !/*$isMobile*/ ctx[3]);
    			add_location(div0, file, 124, 1, 2770);
    			attr_dev(div1, "class", "water-quality");
    			add_location(div1, file, 116, 0, 2610);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*Object, dials, visibleBranch, $isMobile, data*/ 15) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { dials = [] } = $$props;
    	let { data_url = "https://ryanbmarx.github.io/water-quality-dials/data.json" } = $$props;
    	let data = {};
    	let visibleBranch;
    	...
    	onMount(async () => {
    		try {
    			$$invalidate(1, data = await fetch(data_url).then(response => response.json()));
    			console.log(data);
    		} catch(e) {
    	...
    	const writable_props = ['dials', 'data_url'];
    	...
    	function inputselect_value_binding(value) {
    		visibleBranch = value;
    		$$invalidate(2, visibleBranch);
    	}

    	$$self.$$set = $$props => {
    		if ('dials' in $$props) $$invalidate(0, dials = $$props.dials);
    		if ('data_url' in $$props) $$invalidate(6, data_url = $$props.data_url);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('visibleBranch' in $$props) $$invalidate(2, visibleBranch = $$props.visibleBranch);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { dials: 0, data_url: 6 });
