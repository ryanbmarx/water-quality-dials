...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(button, "class", button_class_value = "btn " + /*clazz*/ ctx[4] + " svelte-1b8rp29");
    			button.disabled = /*muted*/ ctx[2];
    			toggle_class(button, "btn--muted", /*muted*/ ctx[2]);
    			add_location(button, file$8, 74, 1, 2102);
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*clazz*/ 16 && button_class_value !== (button_class_value = "btn " + /*clazz*/ ctx[4] + " svelte-1b8rp29")) {
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(a, "class", a_class_value = "btn " + /*clazz*/ ctx[4] + " svelte-1b8rp29");
    			attr_dev(a, "target", /*target*/ ctx[6]);
    			attr_dev(a, "rel", /*rel*/ ctx[5]);
    			add_location(a, file$8, 70, 1, 2001);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*clazz*/ 16 && a_class_value !== (a_class_value = "btn " + /*clazz*/ ctx[4] + " svelte-1b8rp29")) {
    ...
    function create_fragment$7(ctx) {
    	...
    	let t;
    	let current;
    	let if_block0 = /*blurb*/ ctx[1] && create_if_block_1(ctx);
    	let if_block1 = /*link*/ ctx[0] && /*label*/ ctx[2] && create_if_block$4(ctx);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(path0, "class", "highlight svelte-15rr2db");
    			attr_dev(path0, "d", d(/*highlightPercent*/ ctx[3]));
    			add_location(path0, file$6, 107, 2, 2632);
    			attr_dev(path1, "class", "cover svelte-15rr2db");
    			attr_dev(path1, "d", d(/*coverPercent*/ ctx[4]));
    			add_location(path1, file$6, 108, 2, 2685);
    			...
    			add_location(svg, file$6, 102, 1, 2450);
    			attr_dev(div, "class", "circle circle--clip circle--outer-dial svelte-15rr2db");
    			attr_dev(div, "aria-labelledby", div_aria_labelledby_value = "" + (/*uniqueSlug*/ ctx[0] + "-outer-label"));
    			add_location(div, file$6, 99, 0, 2351);
    			attr_dev(strong, "class", "svelte-15rr2db");
    			add_location(strong, file$6, 112, 25, 2816);
    			attr_dev(p, "id", p_id_value = "" + (/*uniqueSlug*/ ctx[0] + "-outer-label"));
    			attr_dev(p, "class", "label svelte-15rr2db");
    			add_location(p, file$6, 111, 0, 2743);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<DialOuter> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('start' in $$props) $$invalidate(1, start = $$props.start);
    		if ('end' in $$props) $$invalidate(2, end = $$props.end);
    		if ('highlightPercent' in $$props) $$invalidate(3, highlightPercent = $$props.highlightPercent);
    	...
    	return [uniqueSlug, start, end, highlightPercent, coverPercent, min, max];
    }
    ...
    class DialOuter extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*min*/ ctx[5] === undefined && !('min' in props)) {
    			console_1$1.warn("<DialOuter> was created without expected prop 'min'");
    		}

    		if (/*max*/ ctx[6] === undefined && !('max' in props)) {
    			console_1$1.warn("<DialOuter> was created without expected prop 'max'");
    		}

    		if (/*start*/ ctx[1] === undefined && !('start' in props)) {
    			console_1$1.warn("<DialOuter> was created without expected prop 'start'");
    		}

    		if (/*end*/ ctx[2] === undefined && !('end' in props)) {
    			console_1$1.warn("<DialOuter> was created without expected prop 'end'");
    		}
    	}
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(title_1, file$5, 32, 12, 507);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(path, "class", "svelte-1er01vr");
    			add_location(path, file$5, 33, 1, 536);
    			attr_dev(circle, "cx", "83.32");
    			attr_dev(circle, "cy", "13");
    			attr_dev(circle, "r", "3.09");
    			attr_dev(circle, "class", "svelte-1er01vr");
    			add_location(circle, file$5, 34, 1, 612);
    			set_style(svg, "transform", "translate(14%, -50%) rotate(" + /*rotation*/ ctx[1] + "deg)");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 96 26");
    			attr_dev(svg, "class", "svelte-1er01vr");
    			add_location(svg, file$5, 28, 0, 368);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			claim_component(needle.$$.fragment, nodes);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	let if_block = /*value*/ ctx[6] >= 0 && create_if_block$2(ctx);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let { uniqueSlug = "" } = $$props;
    	let { average_low = 26 } = $$props;
    	let { average_high = 40 } = $$props;
    	let { min } = $$props;
    	let { max } = $$props;
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t1 = claim_text(time_1_nodes, /*timeFormatted*/ ctx[1]);
    			time_1_nodes.forEach(detach_dev);
    			span_nodes.forEach(detach_dev);
    			this.h();
    		},
    		h: function hydrate() {
    			attr_dev(time_1, "datetime", /*time*/ ctx[0].getTime());
    			add_location(time_1, file$3, 51, 20, 848);
    			attr_dev(span, "class", "timestamp svelte-1q4864t");
    			add_location(span, file$3, 50, 1, 803);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	let if_block_anchor;
    	let if_block = /*timeFormatted*/ ctx[1] && create_if_block$1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*timeFormatted*/ ctx[1]) if_block.p(ctx, dirty);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Timestamp> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ('updated' in $$props) $$invalidate(2, updated = $$props.updated);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('timeFormatted' in $$props) $$invalidate(1, timeFormatted = $$props.timeFormatted);
    	};
    	...
    	return [time, timeFormatted, updated];
    }

    class Timestamp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { updated: 2 });
    ...
    // (144:2) {#each stops as [label, position]}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(li, file$2, 144, 3, 2317);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, li, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(144:2) {#each stops as [label, position]}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span4 = element("span");
    			t5 = text("\n\t\t\tAverage: ");
    			t6 = text(/*average_low*/ ctx[3]);
    			t7 = text("-");
    			t8 = text(/*average_high*/ ctx[2]);
    			t9 = text(" ppb");
    			t10 = space();
    			li1 = element("li");
    			span5 = element("span");
    		...
    		l: function claim(nodes) {
    			...
    			span0 = claim_element(div0_nodes, "SPAN", { style: true, class: true });
    			children(span0).forEach(detach_dev);
    			t1 = claim_space(div0_nodes);
    			span1 = claim_element(div0_nodes, "SPAN", { style: true, class: true });
    			children(span1).forEach(detach_dev);
    			t2 = claim_space(div0_nodes);
    			span2 = claim_element(div0_nodes, "SPAN", { style: true, class: true });
    			children(span2).forEach(detach_dev);
    			t3 = claim_space(div0_nodes);
    			span3 = claim_element(div0_nodes, "SPAN", { style: true, class: true });
    			...
    			t6 = claim_text(li0_nodes, /*average_low*/ ctx[3]);
    			t7 = claim_text(li0_nodes, "-");
    			t8 = claim_text(li0_nodes, /*average_high*/ ctx[2]);
    			t9 = claim_text(li0_nodes, " ppb");
    			li0_nodes.forEach(detach_dev);
    			t10 = claim_space(ul1_nodes);
    			li1 = claim_element(ul1_nodes, "LI", { class: true });
    			var li1_nodes = children(li1);
    			span5 = claim_element(li1_nodes, "SPAN", { class: true });
    			children(span5).forEach(detach_dev);
    			t11 = claim_text(li1_nodes, "\n\t\t\tHigh: ");
    			t12 = claim_text(li1_nodes, /*high*/ ctx[4]);
    			t13 = claim_text(li1_nodes, " ppb");
    			li1_nodes.forEach(detach_dev);
    			t14 = claim_space(ul1_nodes);
    			li2 = claim_element(ul1_nodes, "LI", { class: true });
    			var li2_nodes = children(li2);
    			span6 = claim_element(li2_nodes, "SPAN", { class: true });
    			children(span6).forEach(detach_dev);
    			t15 = claim_text(li2_nodes, "\n\t\t\tLow: ");
    			t16 = claim_text(li2_nodes, /*low*/ ctx[5]);
    			t17 = claim_text(li2_nodes, " ppb");
    			...
    			t19 = claim_text(li3_nodes, "\n\t\t\tLatest: ");
    			t20 = claim_text(li3_nodes, /*value*/ ctx[1]);
    			t21 = claim_text(li3_nodes, " ppb");
    		...
    		h: function hydrate() {
    			...
    			add_location(ul0, file$2, 142, 1, 2258);
    			set_style(span0, "left", /*placeAvgLow*/ ctx[9] + "%");
    			set_style(span0, "width", /*avgWidth*/ ctx[10] + "%");
    			attr_dev(span0, "class", "average svelte-37cakl");
    			add_location(span0, file$2, 150, 2, 2428);
    			set_style(span1, "left", /*placeHigh*/ ctx[6] + "%");
    			attr_dev(span1, "class", "tick tick--high svelte-37cakl");
    			add_location(span1, file$2, 151, 2, 2504);
    			set_style(span2, "left", /*placeLow*/ ctx[7] + "%");
    			attr_dev(span2, "class", "tick tick--low svelte-37cakl");
    			add_location(span2, file$2, 152, 2, 2566);
    			set_style(span3, "left", /*placeValue*/ ctx[8] + "%");
    			attr_dev(span3, "class", "tick tick--value svelte-37cakl");
    			add_location(span3, file$2, 153, 2, 2626);
    			attr_dev(div0, "class", "gauge__chart svelte-37cakl");
    			add_location(div0, file$2, 149, 1, 2399);
    			attr_dev(span4, "class", "average svelte-37cakl");
    			add_location(span4, file$2, 157, 3, 2727);
    			attr_dev(li0, "class", "svelte-37cakl");
    			add_location(li0, file$2, 156, 2, 2719);
    			attr_dev(span5, "class", "tick tick--high svelte-37cakl");
    			add_location(span5, file$2, 161, 3, 2815);
    			attr_dev(li1, "class", "svelte-37cakl");
    			add_location(li1, file$2, 160, 2, 2807);
    			attr_dev(span6, "class", "tick tick--low svelte-37cakl");
    			add_location(span6, file$2, 165, 3, 2886);
    			attr_dev(li2, "class", "svelte-37cakl");
    			add_location(li2, file$2, 164, 2, 2878);
    			attr_dev(span7, "class", "tick tick--value svelte-37cakl");
    			add_location(span7, file$2, 169, 3, 2954);
    			attr_dev(li3, "class", "svelte-37cakl");
    			add_location(li3, file$2, 168, 2, 2946);
    			attr_dev(ul1, "class", "legend svelte-37cakl");
    			add_location(ul1, file$2, 155, 1, 2697);
    			attr_dev(div1, "id", div1_id_value = "" + (/*uniqueSlug*/ ctx[0] + "-gauge"));
    			attr_dev(div1, "class", "gauge svelte-37cakl");
    			add_location(div1, file$2, 141, 0, 2213);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*average_low*/ 8) set_data_dev(t6, /*average_low*/ ctx[3]);
    			if (dirty & /*average_high*/ 4) set_data_dev(t8, /*average_high*/ ctx[2]);
    			if (dirty & /*high*/ 16) set_data_dev(t12, /*high*/ ctx[4]);
    			if (dirty & /*low*/ 32) set_data_dev(t16, /*low*/ ctx[5]);
    			if (dirty & /*value*/ 2) set_data_dev(t20, /*value*/ ctx[1]);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('placeHigh' in $$props) $$invalidate(6, placeHigh = $$props.placeHigh);
    		if ('placeLow' in $$props) $$invalidate(7, placeLow = $$props.placeLow);
    		if ('placeValue' in $$props) $$invalidate(8, placeValue = $$props.placeValue);
    		if ('placeAvgLow' in $$props) $$invalidate(9, placeAvgLow = $$props.placeAvgLow);
    		if ('avgWidth' in $$props) $$invalidate(10, avgWidth = $$props.avgWidth);
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	charts = new Charts({
    			props: {
    				uniqueSlug: /*uniqueSlug*/ ctx[9],
    				average_low: /*average_low*/ ctx[7],
    				average_high: /*average_high*/ ctx[8],
    				min: /*min*/ ctx[3],
    				max: /*max*/ ctx[4],
    				value: /*value*/ ctx[2],
    				main_dial_stops: /*main_dial_stops*/ ctx[5]
    			},
    			$$inline: true
    		});

    	timestamp = new Timestamp({
    			props: { updated: /*updated*/ ctx[10] },
    			$$inline: true
    		});
    	...
    	gauge = new Gauge({
    			props: {
    				...
    				max: /*max*/ ctx[4],
    				value: /*value*/ ctx[2],
    				main_gauge_stops: /*main_gauge_stops*/ ctx[6]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t0 = claim_text(h2_nodes, /*name*/ ctx[0]);
    			...
    			t6 = claim_text(span0_nodes, /*valueLabel*/ ctx[11]);
    			span0_nodes.forEach(detach_dev);
    			t7 = claim_space(div_nodes);
    			span1 = claim_element(div_nodes, "SPAN", { class: true });
    			var span1_nodes = children(span1);
    			t8 = claim_text(span1_nodes, /*value*/ ctx[2]);
    		...
    		h: function hydrate() {
    			attr_dev(h2, "class", "stem svelte-19io1qp");
    			add_location(h2, file$1, 98, 1, 1991);
    			attr_dev(p, "class", "description svelte-19io1qp");
    			add_location(p, file$1, 99, 1, 2021);
    			attr_dev(span0, "class", "label svelte-19io1qp");
    			add_location(span0, file$1, 109, 1, 2194);
    			attr_dev(span1, "class", "value svelte-19io1qp");
    			add_location(span1, file$1, 110, 1, 2235);
    			attr_dev(div, "id", /*uniqueSlug*/ ctx[9]);
    			attr_dev(div, "class", "dial svelte-19io1qp");
    			add_location(div, file$1, 97, 0, 1955);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div, anchor);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*uniqueSlug*/ 512) charts_changes.uniqueSlug = /*uniqueSlug*/ ctx[9];
    			if (dirty & /*average_low*/ 128) charts_changes.average_low = /*average_low*/ ctx[7];
    			if (dirty & /*average_high*/ 256) charts_changes.average_high = /*average_high*/ ctx[8];
    			if (dirty & /*min*/ 8) charts_changes.min = /*min*/ ctx[3];
    			if (dirty & /*max*/ 16) charts_changes.max = /*max*/ ctx[4];
    			if (dirty & /*value*/ 4) charts_changes.value = /*value*/ ctx[2];
    			if (dirty & /*main_dial_stops*/ 32) charts_changes.main_dial_stops = /*main_dial_stops*/ ctx[5];
    			charts.$set(charts_changes);
    			const timestamp_changes = {};
    			if (dirty & /*updated*/ 1024) timestamp_changes.updated = /*updated*/ ctx[10];
    			timestamp.$set(timestamp_changes);
    			if (!current || dirty & /*value*/ 4) set_data_dev(t8, /*value*/ ctx[2]);
    			const gauge_changes = {};
    			if (dirty & /*uniqueSlug*/ 512) gauge_changes.uniqueSlug = /*uniqueSlug*/ ctx[9];
    			if (dirty & /*average_low*/ 128) gauge_changes.average_low = /*average_low*/ ctx[7];
    			if (dirty & /*average_high*/ 256) gauge_changes.average_high = /*average_high*/ ctx[8];
    			if (dirty & /*min*/ 8) gauge_changes.min = /*min*/ ctx[3];
    			if (dirty & /*max*/ 16) gauge_changes.max = /*max*/ ctx[4];
    			if (dirty & /*value*/ 4) gauge_changes.value = /*value*/ ctx[2];
    			if (dirty & /*main_gauge_stops*/ 64) gauge_changes.main_gauge_stops = /*main_gauge_stops*/ ctx[6];
    			gauge.$set(gauge_changes);

    			if (!current || dirty & /*uniqueSlug*/ 512) {
    				attr_dev(div, "id", /*uniqueSlug*/ ctx[9]);
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('max' in $$props) $$invalidate(4, max = $$props.max);
    		if ('main_dial_stops' in $$props) $$invalidate(5, main_dial_stops = $$props.main_dial_stops);
    		if ('main_gauge_stops' in $$props) $$invalidate(6, main_gauge_stops = $$props.main_gauge_stops);
    		if ('average_low' in $$props) $$invalidate(7, average_low = $$props.average_low);
    		if ('average_high' in $$props) $$invalidate(8, average_high = $$props.average_high);
    		if ('labels' in $$props) $$invalidate(12, labels = $$props.labels);
    		if ('uniqueSlug' in $$props) $$invalidate(9, uniqueSlug = $$props.uniqueSlug);
    		if ('updated' in $$props) $$invalidate(10, updated = $$props.updated);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('uniqueSlug' in $$props) $$invalidate(9, uniqueSlug = $$props.uniqueSlug);
    		if ('updated' in $$props) $$invalidate(10, updated = $$props.updated);
    		if ('valueLabel' in $$props) $$invalidate(11, valueLabel = $$props.valueLabel);
    	};
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h1, "class", "headline svelte-1rfm4wl");
    			add_location(h1, file, 50, 15, 927);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(53:2) {#each dials as dial}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "dials svelte-1rfm4wl");
    			add_location(div0, file, 51, 1, 970);
    			attr_dev(div1, "class", "water-quality");
    			add_location(div1, file, 49, 0, 884);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
