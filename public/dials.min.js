...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(br, file$6, 62, 18, 1153);
    			attr_dev(time_1, "datetime", time_1_datetime_value = /*time*/ ctx[1].getTime());
    			add_location(time_1, file$6, 62, 24, 1159);
    			...
    			add_location(span, file$6, 61, 0, 1063);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let if_block = !/*value*/ ctx[9] && create_if_block$2(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(span0, file$2, 143, 1, 3170);
    			...
    			add_location(span1, file$2, 144, 1, 3249);
    ...
    // (313:2) {#each Object.entries(dials) as [id, dial]}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(313:2) {#each Object.entries(dials) as [id, dial]}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file, 311, 1, 8001);
    			attr_dev(div1, "class", "water-quality svelte-1d4pe7o");
    			add_location(div1, file, 300, 0, 7745);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
