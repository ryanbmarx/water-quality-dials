...
var app = (function () {
    ...
    // (308:2) {#each Object.entries(dials) as [id, dial]}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(308:2) {#each Object.entries(dials) as [id, dial]}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file, 306, 1, 7829);
    			attr_dev(div1, "class", "water-quality svelte-1d4pe7o");
    			add_location(div1, file, 295, 0, 7573);
    		},
    		m: function mount(target, anchor) {
    			insert_hydration_dev(target, div1, anchor);
    					...
    					switch (title) {
    						case "Last Hour Average":
    							if (value) {
    								...
    								set_store_value(gaugeData, $gaugeData.main.updated = dateRange.to, $gaugeData);
    							}
    							break;
